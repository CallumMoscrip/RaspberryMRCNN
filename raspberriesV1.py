...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 raspberriesV1.py train --dataset=/host/Mask_RCNN/datasets/raspberry/ --model=/host/Mask_RCNN/logs/raspberry20180918T0102/mask_rcnn_raspberry_0170.h5 --aug=augmentation2

    # Continue training the last model you trained
    python3 coco.py train --dataset=/path/to/coco/ --model=last

    # Run COCO evaluatoin on the last model you trained
    python3 raspberriesV1.py evaluate --dataset=/host/Mask_RCNN/datasets/raspberry/ --model=/host/Mask_RCNN/logs/raspberry20180827T0953/mask_rcnn_raspberry_0130.h5 --limit=100
"""
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        # Just Rotate
        augmentation3 = imgaug.augmenters.Affine(rotate=(-30, 30))  #rotate
            
        # Just Shear
        augmentation4 = imgaug.augmenters.Affine(shear=(-15, 15))  #Shear
        ...
        #augmentations = augmentation1
        #augmentations = augmentation2
        #augmentations = augmentation3
        #augmentations = augmentation4
        #augmentations = augmentation5
