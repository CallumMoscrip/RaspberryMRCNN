...
python3 LoopTrain.py train --dataset=/host/Mask_RCNN/datasets/raspberry/  
...
if __name__ == '__main__':
    ...
    augmentation0 = imgaug.augmenters.Sequential([imgaug.augmenters.Sometimes(0.5,imgaug.augmenters.Fliplr(0.5)),# Flip
                            ...
                            imgaug.augmenters.Sometimes(0.5,imgaug.augmenters.Affine(rotate=(-45, 45))),  #rotate
                            imgaug.augmenters.Sometimes(0.5,imgaug.augmenters.Affine(shear=(-20, 20)))])  #Shear
    ...
    # Just Rotate
    augmentation3 = imgaug.augmenters.Affine(rotate=(-30, 30))  #rotate  increased from 20 to 45

    # Just Shear
    augmentation4 = imgaug.augmenters.Affine(shear=(-15, 15))  #Shear    increased from 10 to 20

    # rotate and shear
    augmentation5 = imgaug.augmenters.Sequential([imgaug.augmenters.Affine(rotate=(-30, 30)),
                    imgaug.augmenters.Affine(shear=(-15, 15))])
    
    weights_list = [None, augmentation0]#, augmentation1, augmentation2, augmentation3, augmentation4, augmentation5 ]
    #weights_list = [augmentation1, augmentation2]
    #weights_list = [augmentation3, augmentation4]
    #weights_list = [augmentation5]
    ...
    for weights in weights_list:
        ...
        augmentations = weights
        print(str(augmentations))
        # Load weights
