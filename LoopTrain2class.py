...
python3 LoopTrain2class.py train --dataset=/host/Mask_RCNN/datasets/raspberry2/  
...
if __name__ == '__main__':
    ...
    #weights_list = [None]#, augmentation0, augmentation0, augmentation0]
    weights_list = [augmentation0, augmentation0, augmentation0]
